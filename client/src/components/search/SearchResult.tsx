...
// Config/utils
import { types, BACKEND_URL, AWS_S3_URL } from '@/config/keys';
                    ...
                    <div className="col-md-6">
                      <div className="card-body">
                        <Link href={`/search/detail/?userId=${sul.id}`}>
                          ...
                          {displayRates(sul as TuitionRateInterface)}
                        </Link>
                      </div>
                    </div>
                    <div className="col-md-3 vertical-center ">
                      ...
                      {authUserInfo?.role !== UserRoleEnum.TEACHER && (
                        <div className="btn-group request-details" role="group" aria-label="Basic example">
                          <button type="button" className="btn btn-primary" onClick={(htsre) => headToSendRequestHandler(htsre, sul.id as number)}>
                            Send Request
                          </button>
