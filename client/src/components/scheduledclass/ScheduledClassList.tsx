      ...
      case StatusEnum.PENDING:
        return authUserInfo.role === UserRoleEnum.TEACHER ? (
          <td>
            ...
            <button type="button" className="btn btn-primary" onClick={(are) => acceptRequestHandler(are, src as CreatedScheduledClassIn)}>
              Accept
            </button>
            <button type="button" className="btn btn-danger" onClick={(are) => rejectRequestHandler(are, src as CreatedScheduledClassIn)}>
              Reject
            </button>
          ...
          <td className="d-flex justify-content-end">
            ...
            {src.types === TuitionStyleEnum.ONLINE && authUserInfo.role === UserRoleEnum.TEACHER && (
              <>
                ...
                <button type="button" className="btn btn-light ms-2 tooptip-wrapper" onClick={(are) => finishClassHandler(are, src as CreatedScheduledClassIn)}>
