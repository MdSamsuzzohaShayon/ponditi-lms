...
// Config/utils
import { userDashboardSidebarList, SEND_CODE, scheduledclassStatus, TS_SELECT } from '@/config/keys';
import axios from '@/config/axios';

// Types
import { AuthUserInfoInterface, SingleUserInterface, RegisterableUserInterface, UserNotificationInterface, IResetPassReqInterface, UserReviewIn } from '@/types/redux/userInterface';
...
const initialResetPassReq: IResetPassReqInterface = { phoneoremail: '', otp: '', password: '', password2: '' };
...
export const userSlice = createSlice({
  ...
  initialState: {
    ...
    selectedUser: { ...initialCurrentUser, role: UserRoleEnum.TEACHER }, // the user whose detail will be shown
    selectedUserRole: UserRoleEnum.TEACHER, // the user whose detail will be shown
