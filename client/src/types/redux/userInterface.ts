...
import { SubjectInterface } from './SubjectClassTuitionmInterface';
...
export interface RegisterableUserInterface {
  ...
  SubjectId?: SubjectInterface[];
  ClassTypeId?: SubjectInterface[];
  TuitionmId?: SubjectInterface[];
}
...
export interface IResetPassReqInterface { }
